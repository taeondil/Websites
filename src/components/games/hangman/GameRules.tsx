    ...
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50">
      <div className="bg-white rounded-2xl p-8 max-w-md w-full mx-4 relative animate-fade-in">
        ...
        <div className="space-y-4 text-gray-600">
          <p>
            Adam asılmadan önce kelimeyi bulmaya çalışın.
          </p>
          ...
          <div>
            ...
            <ul className="list-disc list-inside space-y-2">
              <li>
                <span className="text-red-500 font-medium"> En fazla 6 hatalı harf girme şansınız var. </span>
              </li>
              <li>
              <span className="text-red-500 font-medium">Süre kısıtlaması yok</span> 
              </li>
              <li>
                <span className="text-red-500 font-medium">Eğer bir hata ile karşılaşırsanız yeniden başlatmayı deneyin</span> 
              </li>
            </ul>
          </div>
